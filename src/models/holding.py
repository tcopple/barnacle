class Holding(object):
    def __init__(self, attrs):
        ...
        self.shares = float(attrs["shrsOrPrnAmt"]["sshPrnamt"]) if attrs["shrsOrPrnAmt"]["sshPrnamtType"] == "SH" else None
        self.principle = float(attrs["shrsOrPrnAmt"]["sshPrnamt"]) if attrs["shrsOrPrnAmt"]["sshPrnamtType"] == "PRN" else None
